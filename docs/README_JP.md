...
<p align="center">
  <strong>ファーソナの設定画、参考資料、オリジナルキャラクター（OC）コンテンツ、画像ドキュメントを科学的かつ効率的に管理・整理します ✨</strong>
</p>

<p align="center">
  <a href="docs/README_EN.md">English</a> | <a href="README.md">简体中文</a> | <strong>日本語</strong>
</p>
...
1. 本リポジトリを Fork する
2. 新しいブランチを作成 (`feature/xxxx`)
3. 変更をコミットし、Pull Request を送信
4. レビューをお待ちください
